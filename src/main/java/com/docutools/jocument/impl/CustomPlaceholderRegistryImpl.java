...
public class CustomPlaceholderRegistryImpl implements CustomPlaceholderRegistry {
    ...
    @Override
    public Optional<PlaceholderData> resolve(String placeholder) throws NoSuchMethodException, IllegalAccessException, InvocationTargetException, InstantiationException {
